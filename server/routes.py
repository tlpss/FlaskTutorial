...
# index endpoint = view-function called index -> url is the decorator url of that function -> use url_for!!
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not next_page or url_parse(next_page).netloc != '': # last case to prevent url injection
